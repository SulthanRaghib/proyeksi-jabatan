...
@section('content')
    <x-page-header title="Edit Data Pegawai" :breadcrumbs="[
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-check form-switch mb-3">
                                <input type="checkbox" id="sedang_hukuman_disiplin" name="sedang_hukuman_disiplin" value="1"
                                    ...
                                    @checked(old('sedang_hukuman_disiplin', $pegawai->sedang_hukuman_disiplin))>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Removed run once on load for Edit page so we don't accidentally overwrite existing valid data
        // Only run when user actively changes the Golongan dropdown
    });
</script>
@endpush
