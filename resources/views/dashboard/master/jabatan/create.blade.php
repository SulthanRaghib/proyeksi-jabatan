...
@section('content')
    <x-page-header title="Tambah Jabatan" :breadcrumbs="[
        ['label' => 'Dashboard', 'url' => route('dashboard')],
        ['label' => 'Jabatan', 'url' => route('jabatans.index')],
        ['label' => 'Tambah'],
    ]" />
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('jabatans.store') }}" method="POST" class="row g-3" novalidate>
                    @csrf
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <input type="text" id="nama_jabatan" name="nama_jabatan"
                            ...
                            value="{{ old('nama_jabatan') }}" placeholder="Contoh: Pengawas Radiasi">
                        @error('nama_jabatan')
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select id="jenjang" name="jenjang" class="form-select @error('jenjang') is-invalid @enderror">
                            ...
                            @foreach ($jenjangOptions as $jenjang)
                                <option value="{{ $jenjang }}" @selected(old('jenjang') === $jenjang)>{{ $jenjang }}
                                </option>
                            @endforeach
                        </select>
                        @error('jenjang')
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" step="1" min="0" id="target_ak_kenaikan_pangkat"
                            ...
                            value="{{ old('target_ak_kenaikan_pangkat') }}">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" step="1" min="0" id="target_ak_kenaikan_jenjang"
                            ...
                            value="{{ old('target_ak_kenaikan_jenjang') }}">
